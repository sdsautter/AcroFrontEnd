...
//The main component for the game stage where you submit an answer
export default class SubmissionStage extends Component {
    ...
    inputRender() {
        //Conditionally renders the message under the input depending on what the answerSubmitted state is set to
    ...
    render() {
        return (
                ...
                <div className="row justify-content-between">
                    ...
                    <div className="row">
                    {/*The column containing the game time, letters, and input*/}
                    ...
                    {this.inputRender()}
                        ...
                        {/*The column that displays all the game players */}
                        <div className="col-sm-12 col-lg-3">
                            {/*Loops through the players array to display all the players and points*/}
                            {
