...
export default class ResultsStage extends Component {
        ...
        return (
            <div className="col-11 main-game text-center">
                <div className="row justify-content-between">
                    <LeaveButton gameInstanceId={this.props.gameInstanceId} setFindGameFalse={this.props.setFindGameFalse} />
    ...
    {/*Loops through the results array to create a component to show how many points everyone got*/}
                {
